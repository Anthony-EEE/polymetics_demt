#!/usr/bin/env python3
"""Run and post-check one frozen Bimodal participant training configuration."""
...
def main():
    ...
    parser.add_argument("--participant", required=True, choices=[f"B{i:02d}" for i in range(1, 11)])
