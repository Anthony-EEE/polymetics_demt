#!/usr/bin/env python3
"""Evaluate one Bimodal policy twice on each of the frozen ten Target specs."""
    ...
    try:
        ...
        return {
            ...
            "policy_sampling_seed_rule": (
                "20260807 + B_index*10000 + eval_case_id*10 + repeat_index"
            ),
...
def main():
    ...
    if (
        ...
        raise ValueError("Invalid Bimodal selected-checkpoint manifest")
    ...
    if (
        ...
        raise ValueError("Frozen task thresholds differ from the active Bimodal protocol")
    ...
    sim = BimodalObstacleTransportSim(gui=False, output_dir=None, sample_hz=args.sample_hz)
