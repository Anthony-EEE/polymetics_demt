...
def parse_args():
    parser = argparse.ArgumentParser(description="Convert corrected Ablation-1 raw demos to HDF5.")
...
def main():
    ...
    print("[INFO] Finished corrected Ablation-1 HDF5 conversion", flush=True)
