...
#SBATCH --output=/scratch/prj/eng_demt_robot_learning/polymetics_demt/dataset/abla1_full_arcenter/logs/hdf5-%j.out
#SBATCH --error=/scratch/prj/eng_demt_robot_learning/polymetics_demt/dataset/abla1_full_arcenter/logs/hdf5-%j.err
...
DATASET_ROOT=${DATASET_ROOT:-"${PROJECT_DIR}/dataset/abla1_full_arcenter"}
