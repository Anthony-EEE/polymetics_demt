...
#SBATCH --job-name=tro_s2_collect
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
#SBATCH --output=/scratch/prj/eng_demt_robot_learning/polymetics_demt/dataset/tro_position_stage2_axial/logs/collect-%A_%a.out
#SBATCH --error=/scratch/prj/eng_demt_robot_learning/polymetics_demt/dataset/tro_position_stage2_axial/logs/collect-%A_%a.err
