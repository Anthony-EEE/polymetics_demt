...
DEFAULT_GROUPS = (
    "orn_mvp_R00_d30_seed1",
    "orn_mvp_R15_d30_seed1",
    "orn_mvp_R30_d30_seed1",
)


def parse_args():
    parser = argparse.ArgumentParser(description="Convert orientation MVP raw demos to HDF5.")
...
def main():
    ...
    print("[INFO] Finished orientation MVP HDF5 conversion", flush=True)
